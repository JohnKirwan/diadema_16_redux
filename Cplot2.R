...
test.test <- round(rvonmises(100, mu = rvonmises(1,0,0), kappa = A1inv(0.99), control.circular = list(units='degrees',type='angles',
			modulo='2pi',zero=pi/2,rotation='clock',	template='none'))/5)*5

Cplot2(test.test, kappa.ci = T)